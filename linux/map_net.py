...
import wx,socket,ping,ImageRenderer,os
import wx.grid
...
class MapNetwork(wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(self,None,-1,"Mapa da Rede",size=(410,500),style=wx.MINIMIZE_BOX | wx.SYSTEM_MENU | wx.CAPTION | wx.CLOSE_BOX | wx.CLIP_CHILDREN )
